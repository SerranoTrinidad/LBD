...
/****** Object:  Database [Ejemplo1]    Script Date: 23/02/2019 11:45:49 a.m. ******/
CREATE DATABASE [Ejemplo1]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Ejemplo1', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\Ejemplo1.mdf' , SIZE = 4160KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Ejemplo1_log', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\Ejemplo1_log.ldf' , SIZE = 1040KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [Ejemplo1] SET COMPATIBILITY_LEVEL = 110
GO
...
ALTER DATABASE [Ejemplo1] SET AUTO_CLOSE ON 
GO

ALTER DATABASE [Ejemplo1] SET AUTO_CREATE_STATISTICS ON 
GO
...
ALTER DATABASE [Ejemplo1] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
